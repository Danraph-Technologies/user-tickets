...
function Home() {
  ...
  return (
    <div>
      ...
      <section className="flex flex-col justify-center items-center pb-[100px]   ">
        <div className="flex flex-col justify-center items-center text-center gap-3 max-w-[900px] w-full py-5 rounded-lg  border border-[#0048a74a] bg-[#f5f9fc]">
          <h2 className="text-[25px] font-bold">Still have questions?</h2>
          <p className="font-medium text-gray-500">Our customer support team is here to help you 24/7</p>
